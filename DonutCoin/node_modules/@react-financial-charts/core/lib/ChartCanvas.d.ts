...
import { IZoomAnchorOptions } from "@react-financial-charts/core/lib/zoom/zoomBehavior";
...
export declare class ChartCanvas<TXAxis extends number | Date> extends React.Component<ChartCanvasProps<TXAxis>, ChartCanvasState<TXAxis>> {
    ...
    getCanvasContexts: () => import("@react-financial-charts/core/lib/CanvasContainer").ICanvasContexts | undefined;
