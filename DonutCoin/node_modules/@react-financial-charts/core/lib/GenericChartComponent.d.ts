...
import { GenericComponent } from "@react-financial-charts/core/lib/GenericComponent";
export declare class GenericChartComponent extends GenericComponent {
    static defaultProps: {
        svgDraw: any;
        draw: never[];
        canvasToDraw: (contexts: import("@react-financial-charts/core/lib/CanvasContainer").ICanvasContexts) => CanvasRenderingContext2D | undefined;
        clip: boolean;
        edgeClip: boolean;
        selected: boolean;
        disablePan: boolean;
